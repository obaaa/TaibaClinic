...
<!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
  <!-- Report :: doctor -->
    ...
    <div class="panel panel-default col-md-11">
      <div class="row">
    <div class="panel-heading">Report :: Doctor => Paid</div>
    <div class="panel-body">
      <form action="<?php echo e(url ('report/doctor_paid')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
          <?php echo csrf_field(); ?>
