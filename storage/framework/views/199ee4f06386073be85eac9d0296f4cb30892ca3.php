...
<link rel='stylesheet prefetch' href="<?php echo e(URL::asset('http://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.10.0/bootstrap-table.min.css')); ?>">
<link rel='stylesheet prefetch' href="<?php echo e(URL::asset('http://rawgit.com/vitalets/x-editable/master/dist/bootstrap3-editable/css/bootstrap-editable.css')); ?>">
    ...
    -->
        ...
        <div class="sidebar-wrapper">
              ...
              <ul class="nav">
                  ...
                  <!--<li class="<?php echo e(Request::is('categorie') ? 'active' : ''); ?>">
                      <a href="<?php echo e(URL::to('/categorie')); ?>">
          ...
          <li class="active-pro">
                      <a href="HTTP://obaaa.sd" target="_blank">
                          <img style="margin: auto; display: block;" height="80px" width="40px" src="<?php echo e(asset('assets/img/taiba.png')); ?>" alt="<?php echo e(config('app.name', 'Laravel')); ?>">
                      </a>
                  </li>
              </ul>
        </div>
