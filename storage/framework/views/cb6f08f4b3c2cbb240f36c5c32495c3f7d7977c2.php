                          ...
                          <div class="col-md-2">
                              <div class="form-group">
                                  ...
                                  <select name="categorie_id" class="edit form-control border-input">
                                    <option selected value="<?php echo e($patient->categorie_id); ?>"><?php echo e(App\Categorie::find($patient->categorie_id)->categorie_name); ?></option>
            ...
            <div class="content">
              ...
              <div class="text-center">
                ...
                <?php $__currentLoopData = $visits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  ...
                  <td class="remained">
                    <?php echo e($value->visit_price - $value->visit_paid); ?>
